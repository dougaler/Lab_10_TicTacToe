        ...
        do {
            clearBoard();
                for (int m = 1; m <= 9; ++m) {
                    ...
                    do {
                        rowMove = SafeInput.getRangedInt(in, turn + "'s move. Enter Row: ", 1, 3);
                        rowMove = rowMove -1;
                        colMove = SafeInput.getRangedInt(in, turn + "'s move. Enter Column: ", 1, 3);
                        colMove = colMove - 1;
            ...
            Continue = SafeInput.getYNConfirm(in, "Play Again? [Y/N]");
            System.out.println();
            if(Continue){
